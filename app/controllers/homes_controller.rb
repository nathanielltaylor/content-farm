...
class HomesController < ApplicationController
  def index
    ...
    titles = titles.gsub(/(([0-9]*|a few|an|a|a half) (minutes|hours|minute|hour) ago [0-9]* responses)|Promoted by BuzzFeed Staff Sponsored/, "BREAKPOINT")
    title_array = titles.split("BREAKPOINT")
    title_array.delete_if { |t| /var load_ad/ =~ t }
    binding.pry
